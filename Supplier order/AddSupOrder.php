	...
	<div class="navbar">
  	...
  	<div class="row form1">
  		...
  		<form action="inserted.php" method="POST">
		    ...
		    <input type="text" id="OrId" name="id" placeholder="Enter order id.." required> <br>
		    ...
		    <input type="text" id="Tprice" name="totalprice" pattern="[0-9]*[.]?[0-9]+" placeholder="Ex: xxx.xx" required> <br>
