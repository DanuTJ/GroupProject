...
<body>
  ...
  <div class="container">
    ...
    <section class="dash">
      ...
      <a href="../Registration/registration.php">
        <div class="row">
          <div class="counter-card add">
            ...
            <div class="arrow-div"><img src="images/add.png" alt="add-icon">
          ...
          <a href="../Admin/EditUsers.php">
        <div class="row">
          <div class="counter-card add">
            <div class="arrow-div"><img src="images/edit.png" alt="edit-icon">
              <p class="tags">iHealth</p>
            </div>
            <h2>Edit Users</h2>
          </div>
      ...
      <div class="column">
      <a href="../Admin/ViewAdminUsers.php">
        <div class="row">
           
            <div class="counter-card add">
              <div class="arrow-div"><img src="images/view.png" alt="view-icon">
                <p class="tags">iHealth</p>
              </div>
              <h2>View Users</h2>
            </div>
        ...
        <a href="../Customer/AddCusDetails.php">
        <div class="row">
            <div class="counter-card add">
              <div class="arrow-div"><img src="images/func.png" alt="func-icon">
                <p class="tags">iHealth</p>
              </div>
              <h2>Functions</h2>
            </div>
