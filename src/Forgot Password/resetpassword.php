...
$url = "localhost/iHealth/GroupProject/src/Forgot Password/create_new_pw.php?selector="
...
$headers = "From: iHealth <iHealthAdmin@localhost>\r\n";
$headers .= "Reply-To: iHealthAdmin@localhost\r\n";
